      ...
      <DialogContent className='max-h-[85vh] overflow-y-auto sm:max-w-2xl'>
        ...
        <ol className='list-decimal space-y-3 pl-5 text-sm leading-relaxed text-foreground'>
          ...
          <li>
            ...
            kortai yra laisvi, būtina rezervuoti laiką internetinėje
            rezervacijos sistemoje (jei laikas dar neužimtas), kad kiti asmenys
            matytų, jog aikštelė yra rezervuota.
          </li>
          <li>
            Būtina atšaukti rezervaciją bent 1 val. prieš žaidimo pradžią, jeigu
            planuojate neatvykti. Jei nespėjate atšaukti rezervacijos bent 1
            val. iki žaidimo pradžios, prašome ją atšaukti kuo greičiau, kad
            jūsų rezervuotu laiku galėtų pasinaudoti kiti asmenys. Neatšaukus
            rezervacijos, gali būti apribota galimybė rezervuoti ir žaisti
            teniso kortuose.
          </li>
          <li>
            Teniso kortų rezervaciją galite patvirtinti arba atšaukti
            naudodamiesi nuoroda, kurią gaunate registruodamiesi Vilkaviškio
            lauko teniso kortų rezervacinėje sistemoje
          </li>
          <li>
